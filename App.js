    ...
    return (
      <NavigationContainer>
        <StackApp.Navigator initialRouteName="SplashScreen">
          ...
          <StackApp.Screen name="VaccineWebView" component={VaccineWebView} options={navOptionHandler} />
          <StackApp.Screen name="GrowthtrackWebView" component={GrowthtrackWebView} options={navOptionHandler} />
          <StackApp.Screen name="EddWebView" component={EddWebView} options={navOptionHandler} />
