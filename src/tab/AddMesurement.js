        ...
        <ScrollView style={styles.container}>
          <View style={{ backgroundColor: '#fbb146', height: 135, zIndex: -1, borderBottomLeftRadius: 30, borderBottomRightRadius: 30 }}>
            ...
            <View style={{ flexDirection: 'row' }}>
              ...
              <TouchableOpacity onPress={() => this.props.navigation.navigate('GrowthtrackWebView')} style={[styles.buttonh, { backgroundColor: 'red', width: 180 }]}>
                <View style={{ flexDirection: 'row' }}>
                  <View style={{ backgroundColor: 'white', padding: 10, borderRadius: 35 }}>
                    <Icon
                      name='shopping-bag'
                  ...
                  <Text style={{ color: 'white', padding: 7 }}>{i18n.t('growth.moredetails')}</Text>
